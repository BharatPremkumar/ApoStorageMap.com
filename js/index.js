...
const locations = [
  { id: 0, name: "tåsen senter" },
  { id: 1, name: "gunerius" },
  { id: 2, name: "grunerløkka" },
  { id: 3, name: "St.hanshaugen" },
  { id: 4, name: "kronen" },
  { id: 5, name: "holtet" },
  { id: 6, name: "nordstrand" },
  { id: 7, name: "bryn" },
  { id: 8, name: "tveita" },
  { id: 10, name: "nittedal" },
  { id: 11, name: "hagan" },
  { id: 12, name: "haugerud" },
  { id: 13, name: "haugenstua" },
  { id: 14, name: "nydalen" },
  { id: 15, name: "skøyen" },
  { id: 16, name: "romsås" },
  ...
  { id: 21, name: "lambertseter" },
  { id: 22, name: "storgata" },
  { id: 23, name: "stovner" },
  { id: 24, name: "frogner" },
  { id: 25, name: "ensjø" },
  { id: 26, name: "åråsen lillestrøm" },
  { id: 27, name: "kiellands hus" },
